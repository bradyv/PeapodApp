...
//                .presentationDetents([.height(500),.large])
            ...
            UnevenRoundedRectangle(cornerRadii: .init(topLeading: 32, bottomLeading: 0, bottomTrailing: 0, topTrailing: 32))
                .fill(Color.clear)
                .frame(height:64)
                .overlay(UnevenRoundedRectangle(cornerRadii: .init(topLeading: 32, bottomLeading: 0, bottomTrailing: 0, topTrailing: 32)).strokeBorder(Color.white.opacity(0.25), lineWidth: 1))
                .mask(
