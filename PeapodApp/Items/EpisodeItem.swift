...
struct EpisodeItem: View {
    ...
    var EpisodeActions: some View {
        HStack {
            ...
            if hasStarted {
                MarkAsPlayedButton(episode: episode, foregroundColor: .white, tintColor: .white)
            } else {
                ArchiveButton(episode: episode, foregroundColor: .white, tintColor: .white)
            }
            
            Spacer()
            
            FavButton(episode: episode, foregroundColor: .white, tintColor: .white)
        }
    }
}
